...
class AwsSddcConfig(VapiStruct):
    ...
    def __init__(self,
        ...
        :param one_node_reduced_capacity: Whether this sddc is reduced capacity 1NODE.
        ...
        :param size: The size of the vCenter and NSX appliances. xlarge sddcSize
            corresponds to an 'extra_large' vCenter appliance and 'large' NSX
        ...
        """
        self.region = region
        self.one_node_reduced_capacity = one_node_reduced_capacity
